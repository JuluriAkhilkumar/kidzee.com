...
(function(Q, V, t) {
    ...
    function sa(b, a, c, d) {
        ...
        if (a) {
            ...
            if (L(b))
                for (var f = a.length = 0; f < b.length; f++) e = sa(b[f], null, c, d), D(b[f]) && (c.push(b[f]), d.push(e)), a.push(e);
            else {
                var g = a.$$hashKey;
    ...
    function ja(b, a) {
        ...
        if (c == typeof a && "object" == c)
            if (L(b)) {
                ...
                for (d in a)
                    if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== t && !E(a[d])) return !1;
                return !0
            }
        return !1
    }
    ...
    function Sd(b, a) {
        var c, d, e = Ka.length;
        for (d = 0; d < e; ++d)
            if (c = Ka[d] + a, M(c = b.getAttribute(c))) return c;
        return null
    }
        ...
        if (!wc) {
            ...
            ka && ka.fn.on ? (C = ka, O(ka.fn, {
                ...
                if (Ob) Ob = !1;
                    ...
                    for (var e = 0, f; null != (f = a[e]); e++)(d = ka._data(f, "events")) && d.$destroy && ka(f).triggerHandler("$destroy");
                b(a)
            }) : C = P;
            ba.element =
                C;
    ...
    function pb(b, a) {
        ...
        if (b.querySelectorAll)
            for (var c = b.querySelectorAll("*"), d = 0, e = c.length; d < e; d++) qb(c[d])
    }

    function Jc(b, a, c, d) {
        if (z(d)) throw Rb("offargs");
        var e = (d = rb(b)) && d.events,
            f = d && d.handle;
        if (f)
    ...
    function yc(b, a) {
        ...
        var e = {},
            f = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/,
            g = /(([\w\-]+)(?:\:([^;]+))?;?)/,
            h = Qd("ngSrc,ngSrcset,src,srcset"),
            l = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/,
            k = /^(on[a-z]+|formaction)$/;
            ...
            M(a) ? (d(a), Pb(f, "directiveFactory"), e.hasOwnProperty(a) || (e[a] = [], b.factory(a + "Directive", ["$injector", "$exceptionHandler", function(b, d) {
                ...
                n(e[a], function(e, g) {
                    try {
                        ...
                        E(h) ? h = {
                            compile: oa(h)
                        } : !h.compile && h.link && (h.compile = oa(h.link));
        ...
        this.$get = ["$injector",
            ...
            function(a, b, c, d, u, p, w, q, K, B, N) {
                function A(a, b) {
                    try {
                        a.addClass(b)
                    } catch (c) {}
                ...
                function da(a, b, c, d, e) {
                    ...
                    switch (a.nodeType) {
                        case na:
                            ...
                            D(a) && (a = a.animVal);
                            if (M(a) && "" !== a)
                                for (; k = g.exec(a);) l = wa(k[2]), v(b, l, "C", d, e) && (c[l] = S(k[3])), a =
                ...
                function I(a,
                    ...
                    for (var J = -Number.MAX_VALUE, N, Y = m.controllerDirectives, A = m.newIsolateScopeDirective, u = m.templateDirective,
                        ...
                        if (v = I.transclude) w = !0, I.$$tlb || (P("transclusion", n, I, W), n = I), "element" == v ?
                            (q = !0, J = I.priority, v = W, W = d.$$element = C(V.createComment(" " + x + ": " + d[x] + " ")), b = W[0], X(f, pa.call(v, 0), b), Ga = R(v, e, J, g && g.name, {
                                nonTlbTranscludeDirective: n
                            })) : (v = C(Sb(b)).contents(), W.empty(), Ga = R(v, e));
                        if (I.template)
                            if (K = !0, P("template", u, I, W), u = I, v = E(I.template) ? I.template(W, d) : I.template, v = ga(v), I.replace) {
                                g = I;
                ...
                function z(a) {
                    for (var b = 0, c = a.length; b < c; b++) a[b] = Lb(a[b], {
                        $$isolateScope: !0
                    })
                }
                ...
                function Ff(a, b, c, e, f, g, h, k) {
                    var l = [],
                        ...
                        H = E(B.templateUrl) ? B.templateUrl(b, c) : B.templateUrl,
                ...
                ca.prototype = {
                    ...
                    $set: function(a, b, d, e) {
                        ...
                        if ("a" === g && "href" === a || "img" === g && "src" === a) this[a] = b = N(b, "src" === a);
                            ...
                            for (var g = "", h = S(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(h) ? k : /(,)/, h = h.split(k), k = Math.floor(h.length / 2), l = 0; l < k; l++) var m = 2 * l,
                                g = g + N(S(h[m]), !0),
                                g = g + (" " + S(h[m + 1]));
                            h = S(h[2 * l]).split(/\s/);
                            g += N(S(h[0]), !0);
        ...
        this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(d, e, f, g, h, l) {
            function k(a) {
                ...
                e.headers = function(a) {
                    var c = b.headers,
                        e = O({}, a.headers),
                        f, g, h, c = O({}, c.common, c[F(a.method)]);
                    a: for (f in c) {
                        g = F(f);
                        for (h in e)
                            if (F(h) === g) continue a;
                ...
                var f = [function(a) {
                        var d = a.headers,
                            e = $c(a.data, Zc(d), t, a.transformRequest);
            ...
            function m(c, f) {
                ...
                var K = h.defer(),
                    B = K.promise,
                    N, A, R = c.headers,
                    Y = r(c.url, c.paramSerializer(c.params));
    ...
    function Ue() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function(c, d, e) {
            ...
            function h(f, h, m, r) {
                ...
                r = !!r;
                for (var p, n, q = 0, K = [], B = [], N = f.length, A = [], R = []; q < N;)
                    if (-1 != (p = f.indexOf(b, q)) && -1 != (n = f.indexOf(a, p + l))) q !== p && A.push(g(f.substring(q, p))), q = f.substring(p + l, n), K.push(q), B.push(c(q, u)), q = n + k, R.push(A.length), A.push("");
                    else {
                ...
                $watchCollection: function(a, b) {
                    function c(a) {
                        ...
                        if (!v(e)) {
                            if (D(e))
                                if (Qa(e))
                                    for (f !== r && (f = r, n = f.length = 0, k++), a = e.length, n !== a && (k++, f.length = n = a), b = 0; b < a; b++) h = f[b],
                                        g = e[b], d = h !== h && g !== g, d || h === g || (k++, f[b] = g);
                                else {
                                    f !== s && (f = s = {}, n = 0, k++);
                                    a = 0;
                        ...
                        a: do {
                            if (k = y.$$watchers)
                                for (m = k.length; m--;) try {
                                    if (b = k[m])
                                        if ((f = b.get(y)) !== (h = b.last) && !(b.eq ? ja(f, h) : "number" === typeof f && "number" === typeof h && isNaN(f) && isNaN(h))) s = !0, d = b, b.last = b.eq ? sa(f, null) : f, b.fn(f, h === q ? f : h, y), 5 >
    ...
    function hf() {
        this.$get = ["$window", "$document", function(b, a) {
            var c = {},
                d = aa((/android (\d+)/.exec(F((b.navigator || {}).userAgent)) || [])[1]),
    ...
    function rd(b) {
        ...
        return function() {
            ...
            b = c.cookie || "";
            if (b !== e)
                for (e = b, b = e.split("; "), d = {}, h = 0; h < b.length; h++) g = b[h], l = g.indexOf("="), 0 < l && (k = a(g.substring(0, l)), d[k] === t && (d[k] = a(g.substring(l + 1))));
            return d
        }
    }
        ...
        switch (f) {
            case "object":
                ...
                if ("object" ===
                    g) {
                    for (h in a)
                        if (e = a[h], !E(e) && !v(e) && (f = "$" === h, !Ia(f ? b : b[h], e, c, f, f))) return !1;
                    return !0
                }
                return c(b, a);
            case "function":
    ...
    function vd(b) {
        return function(a, c, d) {
            ...
            function g(a) {
                return null === a ? "null" : "function" === typeof a.valueOf && (a = a.valueOf(), f(a)) || "function" ===
                    typeof a.toString && (a = a.toString(), f(a)) ? a : ""
            }
    ...
    function Ad(b, a, c, d, e) {
        var f = this,
            g = [],
            h = f.$$parentForm = b.parent().controller("form") || Fb;
        f.$error = {};
        f.$$success = {};
        f.$pending = t;
    ...
    var dg = /^\/(.+)\/([a-z]*)$/,
        ...
        Ca = G("ng"),
        ba = Q.angular || (Q.angular = {}),
        bb, jb = 0;
    fb = V.documentMode;
    x.$inject = [];
    Sa.$inject = [];
    var L = Array.isArray,
        nc = /^\[object (Uint8(Clamped)?)|(Uint16)|(Uint32)|(Int8)|(Int16)|(Int32)|(Float(32)|(64))Array\]$/,
        S = function(b) {
            return M(b) ? b.trim() : b
        },
        od = function(b) {
        ...
        lb = function() {
            ...
            var b, a, c = Ka.length,
                d, e;
            for (a = 0; a < c; ++a)
                if (d = Ka[a], b = V.querySelector("[" + d.replace(":", "\\:") + "jq]")) {
    ...
    var tf = /([\:\-\_]+(.))/g,
        ...
        Qb = /<|&#?\w+;/,
        vf = /<([\w:]+)/,
        wf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
        ga = {
        ...
        attr: function(b, a, c) {
            ...
            if (d !== Za && 2 !== d && 8 !== d)
                if (d = F(a), xb[d])
                    ...
                    else return b[a] || (b.attributes.getNamedItem(a) || x).specified ? d : t;
                ...
                switch (arguments.length) {
                    ...
                    case 1:
                        if (M(a) || T(a)) a = a.toString(), this.$$search =
                            sc(a);
                        else if (D(a)) a = sa(a, {}), n(a, function(c, e) {
                            null == c && delete a[e]
                        }), this.$$search = a;
                        else throw zb("isrcharg");
                        break;
                    default:
        ...
        readString: function(a) {
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length;) {
                ...
                if (f) "u" === g ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) ||
                    this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d += lg[g] || g, f = !1;
                else if ("\\" === g) f = !0;
                else {
                    if (g === a) {
                        this.index++;
    ...
    var xd = ".",
        ...
        ag = /((?:[^yMdHhmsaZEwG']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|G+|w+))(.*)/,
        $f = /^\-?\d+$/;
    td.$inject = ["$locale"];
    var Xf = oa(F),
        Yf = oa(nb);
    ...
    var Hd = function(a) {
        ...
        de = Hd(),
        qe = Hd(!0),
        cg = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/,
        mg = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
        ng = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i,
        og = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,
        Id = /^(\d{4})-(\d{2})-(\d{2})$/,
        Jd = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/,
        jc = /^(\d{4})-W(\d\d)$/,
        Kd = /^(\d{4})-(\d\d)$/,
        Ld = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/,
        Md = {
            ...
            checkbox: function(a, c, d, e, f, g, h, l) {
                var k = Dd(l, a, "ngTrueValue", d.ngTrueValue, !0),
                    m = Dd(l, a, "ngFalseValue", d.ngFalseValue, !1);
                c.on("click", function(a) {
    ...
    var se = ["$animate", function(a) {
        ...
        Gd = "ng-pending",
        Ib = new G("ngModel"),
        rg = ["$scope", "$exceptionHandler", "$attrs",
            ...
            function(a, c, d, e, f, g, h, l, k, m) {
                ...
                var w = e.inheritedData("$formController") || Fb,
                    C = 0;
                Bd({
                    ctrl: this,
                    $element: e,
        ...
        tg = G("ngOptions"),
        ug = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,
        De = ["$compile", "$parse", function(a, c) {
            function d(a, d, e) {
            ...
            var e = V.createElement("option"),
                f = V.createElement("optgroup");
            return {
                restrict: "A",
                terminal: !0,
                ...
                link: function(c, h, l, k) {
                    ...
                    if (x) {
                        var u = k[0];
                        k = l.multiple;
                        for (var p, w = 0, z = h.children(), K = z.length; w < K; w++)
                            if ("" === z[w].value) {
                                p = z.eq(w);
                                break
                            }
                    ...
                    return function(a, f, g, k, m) {
                        ...
                        a.$watchCollection(r, function(g) {
                            ...
                            if (Qa(g)) L = g, r = p || w;
                                ...
                                for (O in r = p || D, L = [], g) g.hasOwnProperty(O) && "$" !== O.charAt(0) && L.push(O);
                            E = L.length;
                            O = Array(E);
                            for (k = 0; k < E; k++)
                                if (K = g === L ? k : L[k], M = g[K], G = r(K, M, k), v[G]) F = v[G], delete v[G], A[G] = F, O[k] = F;
                                else {
                            ...
                            for (y in v) {
                                ...
                                c.leave(G);
                                if (G[0].parentNode)
                                    for (k = 0, r = G.length; k <
                                        r; k++) G[k].$$NG_REMOVED = !0;
                                F.scope.$destroy()
                            }
                            for (k = 0; k < E; k++)
                                if (K = g === L ? k : L[k], M = g[K], F = O[k], F.scope) {
                                    y = u;
        ...
        wg = ["$element", "$scope", "$attrs", function(a, c, d) {
            var e = this,
                f = new Oa;
            e.ngModelCtrl = vg;
